(function () {
    ...
    angular.module('myApp').controller('viagensController', viagensController);

    viagensController.$inject = ['viagensAPI','$scope','$rootScope', '$location', '$route', '$filter'];

    function viagensController(viagensAPI, $scope, $rootScope, $location, $route, $filter) {
