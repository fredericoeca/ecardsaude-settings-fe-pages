 ...
 * similar to how application controller are configured with `$routeProvider`. Because these methods convert
 * the definition url to regex, declaration order is important. Combined with query parameter parsing,
 * the following is possible:
 *
  ```js
    $httpBackend.whenRoute('GET', '/usuarios/:id')
      .respond(function(method, url, data, headers, params) {
        return [200, MockUserList[Number(params.id)]];
      });

    $httpBackend.whenRoute('GET', '/usuarios')
      .respond(function(method, url, data, headers, params) {
        var userList = angular.copy(MockUserList),
          defaultSort = 'lastName',
          count, pages, isPrevious, isNext;

        // paged api response '/v1/usuarios?page=2'
        params.page = Number(params.page) || 1;

        // query for last names '/v1/usuarios?q=Archer'
        if (params.q) {
        ...
        return [200, {
          ...
          previous: isPrevious,
          next:     isNext,
          // sort field -> '/v1/usuarios?sortBy=firstName'
